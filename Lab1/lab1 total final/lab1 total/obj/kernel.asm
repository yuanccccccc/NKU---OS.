...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200418:	c0c78793          	addi	a5,a5,-1012 # 80204020 <tick>
    8020041c:	6398                	ld	a4,0(a5)
            if (tick >= 100) {
    8020041e:	06300693          	li	a3,99
            tick++;  // 增加时钟中断计数
    80200422:	0705                	addi	a4,a4,1
    80200424:	e398                	sd	a4,0(a5)
            if (tick >= 100) {
    80200426:	639c                	ld	a5,0(a5)
    80200428:	00f6eb63          	bltu	a3,a5,8020043e <interrupt_handler+0x7a>
            break;
        default:
            print_trapframe(tf);
            break;
    ...
    80200436:	b0e50513          	addi	a0,a0,-1266 # 80200f40 <etext+0x520>
    ...
    80200446:	aee50513          	addi	a0,a0,-1298 # 80200f30 <etext+0x510>
    ...
    80200456:	6398                	ld	a4,0(a5)
                if (num >= 10) {
    80200458:	46a5                	li	a3,9
                num++;  // 增加打印行计数
    8020045a:	0705                	addi	a4,a4,1
    8020045c:	e398                	sd	a4,0(a5)
                if (num >= 10) {
    8020045e:	639c                	ld	a5,0(a5)
    80200460:	fcf6f6e3          	bgeu	a3,a5,8020042c <interrupt_handler+0x68>
}
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    802005f4:	a3078793          	addi	a5,a5,-1488 # 80201020 <etext+0x600>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    80200650:	a08a8a93          	addi	s5,s5,-1528 # 80201054 <etext+0x634>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
    ...
    80200658:	bdcb8b93          	addi	s7,s7,-1060 # 80201230 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
    ...
    802008ae:	7a660613          	addi	a2,a2,1958 # 80201050 <etext+0x630>
    ...
    802008c0:	78460613          	addi	a2,a2,1924 # 80201040 <etext+0x620>
    ...
    802008d2:	76a40413          	addi	s0,s0,1898 # 80201038 <etext+0x618>
    ...
    8020095c:	6e040413          	addi	s0,s0,1760 # 80201038 <etext+0x618>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
    ...
    80200972:	6cba0a13          	addi	s4,s4,1739 # 80201039 <etext+0x619>
